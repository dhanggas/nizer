...
public class DaftarSkmView extends javax.swing.JInternalFrame {
    ...
    private final RepoSkm repoSkm;
    private List<SuratKematian> daftarSkm;
    private List<SuratKematian> daftarSkm2;
    private Users p = null;
    private SuratKematian sk = null;
     ...
     */
    public DaftarSkmView(MainMenuView menuController) {
        initComponents();
        this.menuController = menuController;
        this.tableController = new TableViewController(tableView);
        this.repoSkm = new ServiceSkm(KoneksiDB.getDataSource());
        this.sk = new SuratKematian();
        this.daftarSkm = new ArrayList<>();
        this.daftarSkm2 = new ArrayList<>();
        refreshDataTablesByName();
    }

    public DaftarSkmView(MainMenuView menuController, Users p) {
        initComponents();
        this.menuController = menuController;
        this.tableController = new TableViewController(tableView);
        this.repoSkm = new ServiceSkm(KoneksiDB.getDataSource());
    ...
    public void refreshDataTables() {
        try {
            ...
            this.daftarSkm = repoSkm.findAll();
            for (SuratKematian k : daftarSkm) {
                Object[] row = {k.getNo_skm(), k.getTgl_kematian(), k.getPenduduk().getNik(), k.getPenduduk().getNama(), k.getTmp_kematian(), k.getSebab(), k.getPenduduk().getNama_ibu(), k.getPenduduk().getNama_ayah(), k.getPenduduk().getTmp_lahir(), k.getPenduduk().getTgl_lahir(),
    ...
    public void refreshDataTablesByName() {
        try {
            tableController.clearData();
            this.daftarSkm = repoSkm.findByNama(txtCari.getText());
            for (SuratKematian k : daftarSkm) {
                Object[] row = {k.getNo_skm(), k.getTgl_kematian(), k.getPenduduk().getNik(), k.getPenduduk().getNama(), k.getTmp_kematian(), k.getSebab(), k.getPenduduk().getNama_ibu(), k.getPenduduk().getNama_ayah(), k.getPenduduk().getTmp_lahir(), k.getPenduduk().getTgl_lahir(),
                    k.getPenduduk().getKelamin(), k.getPenduduk().getGol_darah(), k.getPenduduk().getAlamat(), k.getPenduduk().getRt(), k.getPenduduk().getRw(), k.getPenduduk().getKelurahan(),
                    k.getPenduduk().getKecamatan(), k.getPenduduk().getAgama(), k.getPenduduk().getPendidikan(), k.getPenduduk().getSts_kawin(), k.getPenduduk().getPekerjaan(), k.getPenduduk().getKewarganegaraan(), k.isVerifikasi()};
    ...
    private void initComponents() {
        ...
        tableView.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No SKM", "Tanggal Kematian", "Nik", "Nama"
            }
        ) {
        ...
        jLabel19.setText("Tgl Kematian");

        txtTempatKematian.setEditable(false);
        ...
        txtTglKematian.setEditable(false);
        txtTglKematian.setHorizontalAlignment(javax.swing.JTextField.LEFT);

        txtNoSkm.setEditable(false);
        txtNoSkm.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        ...
        jLabel21.setText("Sebab");

        txtSebab.setEditable(false);
        txtSebab.setColumns(20);
        txtSebab.setLineWrap(true);
        txtSebab.setRows(5);
        jScrollPane2.setViewportView(txtSebab);
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(txtNoSkm, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnVerifikasi, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtNik, javax.swing.GroupLayout.PREFERRED_SIZE, 239, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addComponent(txtTempatKematian, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtTglKematian, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(txtNoSkm, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtTglKematian, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel12, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtTempatKematian, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahActionPerformed
        if (btnVerifikasi.getText().equals("Unverifikasi")) {
            ...
            if (tableController.isSelected()) {
                ...
                DataSkmView view = new DataSkmView(menuController, this, ktp, true, p);
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        DataSkmView view = new DataSkmView(menuController, this, true, p);
        view.setResizable(false);
        view.setLocationRelativeTo(null);
        view.setVisible(true);
...
//        if (tableController.isSelected()) {
//            SuratKematian penduduk = daftarAset.get(tableController.getRowSelected());
...
//        }
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        if (tableController.isSelected()) {
            try {
                this.daftarSkm2 = repoSkm.findByNama(txtNoSkm.getText());
                String url = "/laporan/sutarKematian.jasper";
                Map<String, Object> map = new HashMap<>();
//                map.put("nama", ktp.getPenduduk().getNama());
                JasperPrint print = JasperFillManager.fillReport(
                        getClass().getResourceAsStream(url),
                        map,
                        new JRBeanCollectionDataSource(daftarSkm2));
    ...
    private void btnVerifikasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerifikasiActionPerformed
        ...
        if (tableController.isSelected()) {
            try {
                SuratKematian k = new SuratKematian();
                k.setNo_skm(txtNoSkm.getText());
                Penduduk penduduk = new Penduduk();
                penduduk.setNik(txtTempatKematian.getText());
                k.setPenduduk(penduduk);
                if (btnVerifikasi.getText().equals("Verifikasi")) {
                    k.setVerifikasi(true);
                    repoSkm.verifikasi(k);
    ...
    private javax.swing.JTextArea txtSebab;
    private javax.swing.JTextField txtTempatKematian;
    private javax.swing.JTextField txtTglKematian;
    ...
    public void setFields(SuratKematian suratKematian) {
        txtNoSkm.setText(suratKematian.getNo_skm());
        txtTglKematian.setText(suratKematian.getTgl_kematian().toString());
        txtTempatKematian.setText(suratKematian.getTmp_kematian());
        if (suratKematian.isVerifikasi()) {
        ...
        txtNik.setText(suratKematian.getPenduduk().getNik());
        txtNama.setText(suratKematian.getPenduduk().getNama());
        txt_tmp_lahir.setText(suratKematian.getPenduduk().getTmp_lahir());
        txt_tgl_lahir.setText(suratKematian.getPenduduk().getTgl_lahir().toString());
        txt_kelamin.setText(suratKematian.getPenduduk().getKelamin());
        txtSebab.setText(suratKematian.getSebab());

    }

    public void clearFields() {
        txtNoSkm.setText("");
        txtTglKematian.setText("");
        txtTempatKematian.setText("");
        txtNik.setText("");
        txtNama.setText("");
