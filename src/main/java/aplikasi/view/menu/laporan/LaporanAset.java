...
//                Object[] row = {aset.getNik(), aset.getNama(), aset.getKategoriAset().getNama_kategori(),
//                    aset.getStatusAset().getStatus(), aset.getLokasiAset().getNama_rak(), aset.getLokasiAset().getLokasi(),
//                    aset.getKepemilikan().getNama(), aset.getQty(), aset.getNama_ibu(), aset.getUsers().getUsername()};
